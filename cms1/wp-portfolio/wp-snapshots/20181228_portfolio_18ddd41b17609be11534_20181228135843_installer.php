...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181228_portfolio_18ddd41b17609be11534_20181228135843_archive.zip';
	const ARCHIVE_SIZE		 = '24841135';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '18ddd41-28135843';
	const VERSION			 = '1.3.0';
